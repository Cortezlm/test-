...
print (f"john has {john} apple, mary has {mary} apples and adam has {adam} apples") 
print (total_apples)
mary john + adam == total_apples
print ("mary now has 10 apples, john now has 2 apples")